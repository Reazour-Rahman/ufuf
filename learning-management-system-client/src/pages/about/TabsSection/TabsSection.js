    ...
    <AutoContainer>
      <Box sx={{ width: "100%" }}>
        <Tabs
          ...
          TabIndicatorProps={{
            style: { background: "#5F2DED", height: "5px" },
          }}
        >
        ...
        {value === "about" && (
          <p>
            ...
            designing. Because I love to solve the design problem and find easy
            and better solutions to solve it. I always try my best to make good
            user interface with the best user experience. I have been working as
            a UX Designer More About About Course awards education DPR
            Engineering Dhaka University There are many variations of passages
            of Lorem Ipsum available, but the majority have suffered alteration
            in some form, by injected humour, or randomised words look even
        ...
        {value === "course" && (
          <p>
            ...
            some form, by injected humour, There are many variations of passages
            of Lorem Ipsum available, but the majority have suffered alteration
            ...
            which dont look even slightly believable. If you are going to useery
            user research award 2020 Dsigning award 2021 Computer Science -
            england There are many variations of passages of Lorem Ipsum
        ...
        {value === "awards" && (
          <p>
            ...
            england There are many variations of passages of Lorem Ipsum
            available, but the majority have suffered alteration in some form,
            by injected humour, pro product desgin with udemey There are many
